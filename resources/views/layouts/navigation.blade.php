            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center gap-3">
                    <a href="{{ route('dashboard') }}" class="flex items-center gap-2">
                        ...
                        <span class="font-bold text-lg text-gray-800 dark:text-gray-200">Barangay Complaints System</span>
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    @if (Auth::user()->isAdmin())
                        ...
                        <x-nav-link :href="route('admin.hearings.index')" :active="request()->routeIs('admin.hearings.*')">
                            Hearings
                        </x-nav-link>
                    @else
                        ...
                        <x-nav-link :href="route('resident.hearings.index')" :active="request()->routeIs('resident.hearings.*')">
                            Hearings
                        </x-nav-link>
                    @endif
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            @if (Auth::user()->isAdmin())
                ...
                <x-responsive-nav-link :href="route('admin.hearings.index')" :active="request()->routeIs('admin.hearings.*')">
                    Hearings
                </x-responsive-nav-link>
            @else
                ...
                <x-responsive-nav-link :href="route('resident.hearings.index')" :active="request()->routeIs('resident.hearings.*')">
                    Hearings
                </x-responsive-nav-link>
            @endif
        </div>
